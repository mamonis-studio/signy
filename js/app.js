...
const Signy = (() => {
  ...
  const T = {
    ja: {
      ...
      'dash.usage':'今月の使用量','dash.upgrade':'PROにアップグレード',
      'st.pending':'署名待ち','st.signed':'署名済み','st.expired':'期限切れ','st.cancelled':'取り消し',
      'dash.search.ph':'タイトル・署名者・金額で検索...','dash.filter.all':'すべて','dash.filter.pending':'署名待ち','dash.filter.signed':'署名済み',
      ...
      'footer':'Signy — mamonis.studio','footer.priv':'プライバシーポリシー','footer.terms':'利用規約','footer.law':'特定商取引法に基づく表記','footer.ebooks':'電帳法対応',
    ...
    en: {
      ...
      'dash.usage':'Monthly usage','dash.upgrade':'Upgrade to PRO',
      'st.pending':'Pending','st.signed':'Signed','st.expired':'Expired','st.cancelled':'Cancelled',
      'dash.search.ph':'Search by title, signer, or amount...','dash.filter.all':'All','dash.filter.pending':'Pending','dash.filter.signed':'Signed',
      ...
      'footer':'Signy — mamonis.studio','footer.priv':'Privacy Policy','footer.terms':'Terms of Service','footer.law':'Specified Commercial Transactions','footer.ebooks':'e-Books Act',
